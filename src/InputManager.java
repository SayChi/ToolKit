// As created by Bastiaan Wuisman on 19-7-2015
...
public class InputManager implements KeyListener, MouseListener, MouseWheelListener {
	...
	void poll() {
		if( jFrame != null ) {
			mouseLoc.x = MouseInfo.getPointerInfo().getLocation().x - jFrame.getLocationOnScreen().x;
			mouseLoc.y = MouseInfo.getPointerInfo().getLocation().y - jFrame.getLocationOnScreen().y;
		}
